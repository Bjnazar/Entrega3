<nav>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <a href="views/suscripciones_streaming.php">Streaming</a>
            <a href="views/suscripciones_videojuegos.php">Videojuegos</a>
        </div>
    </div>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <a href="views/compras_streaming.php">Streaming</a>
            <a href="views/compras_videojuegos.php">Videojuegos</a>
        </div>
    </div>

    <a href="views/consulta.php">Consulta Inestructurada</a>
    <a href="views/creatividad.php">Creatividad</a>
